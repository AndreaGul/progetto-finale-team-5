const required = ["nome", "cognome", "indirizzo"];
...
submit.addEventListener("click", (event) => {
    ...
    elementsText.forEach((element) => {
        if (!required.includes(element.id) && element.value.length === 0) {
            ...
            setErrorText(
                element,
                element.id + " deve contenere almeno 3 e massimo 20 caratteri",
                arrayErrorText
            );
            ...
            setErrorText(
                element,
                element.id + " deve contenere solo caratteri alfabetici",
                arrayErrorText
            );
        } else {
            element.classList.remove("border", "border-danger");
    ...
    elementsEmail.forEach((element) => {
        if (!required.includes(element.id) && element.value.length === 0) {
            ...
            setErrorText(
                element,
                element.id + " non è un email valida",
                arrayErrorText
            );
        } else {
            element.classList.remove("border", "border-danger");
    ...
    elementsNumber.forEach((element) => {
        if (!required.includes(element.id) && element.value.length === 0) {
            ...
            setErrorText(
                element,
                element.id + " non è un valore numerico",
                arrayErrorText
            );
        } else if (
            (element.id === "telefono" && element.value.length > 20) ||
            (element.id === "telefono" && element.value.length < 10)
        ) {
            element.classList.add("border", "border-danger");
            authorize = false;
            setErrorText(
                element,
                element.id + " deve contenere almeno 10 e massimo 20 numeri",
                arrayErrorText
            );
            ...
            setErrorText(
                element,
                element.id + " deve contenere almeno 1 e massimo 255 numeri",
                arrayErrorText
            );
        } else {
            element.classList.remove("border", "border-danger");
    ...
    elementsBigText.forEach((element) => {
        if (!required.includes(element.id) && element.value.length === 0) {
            ...
            (element.id === "indirizzo" && element.value.length > 255) ||
            ...
            setErrorText(
                element,
                element.id + " deve contenere almeno 5 e massimo 255 caratteri",
                arrayErrorText
            );
        } else {
            element.classList.remove("border", "border-danger");
