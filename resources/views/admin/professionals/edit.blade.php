...
@section('content')
 ...
 <form class="row g-3 my-3" action=" {{route('admin.info.update',$user)}}" method="POST" enctype="multipart/form-data" id="form">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="nome" name="name" value="{{old('name', $user->name)}}" required>
  </div>
  <div class="col-12">
    <label for="surname" class="form-label">Cognome</label>
    <input type="text" class="form-control" id="cognome" name="surname" value="{{old('surname', $user->surname)}}"  required>
  </div>
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="telefono" name="phone" value="{{old('phone', $user->$professional?->phone)}}"  >
  </div>

  <div class="col-12">
    <label for="address" class="form-label">Indirizzo</label>
    <input type="text" class="form-control" id="indirizzo" name="address" value="{{old('address', $user->$professional?->address)}}"  >
  </div>
  ...
  <div class="col-12">
    ...
    <div class="form-floating">
      <textarea name="performance" id="descrizione" cols="30" rows="10" class="form-control p-1" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">
